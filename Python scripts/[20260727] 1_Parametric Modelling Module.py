...
if InputFile1 != None:
    isomer1 = pd.read_csv(InputFile1)   
...
if InputFile2 != None:
    isomer2 = pd.read_csv(InputFile2)
...
raw_isomer1PeakCoV.to_csv(isomer1_filename)
raw_isomer2PeakCoV.to_csv(isomer2_filename)
...
norm_rawisomer1.to_csv(norm_isomer1_filename)
norm_rawisomer2.to_csv(norm_isomer2_filename)
# In[ ]:
...
norm_isomer1Parameters.to_csv(norm_isomer1Parameters_filename)
norm_isomer2Parameters.to_csv(norm_isomer2Parameters_filename)
...
## Output Gaussian files
CombinedAnalysis.to_csv('Module1_Outputs/CombinedAnalysis.csv')
...
meanAllsigma.to_csv('Module1_Outputs/meanAllsigma.csv', columns =['SV',('sigma_' + isomer1_name), ('sigma_' + isomer2_name)])
...
Intersected_gauss.to_csv('Module1_Outputs/Intersected gauss.csv')
